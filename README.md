# 🎮 Space Monster Battle - Proyecto Final Python
...
1. **Descarga el proyecto:** Haz clic en el botón verde `<> Code` de la página principal del repositorio y selecciona **Download ZIP** (luego descomprime la carpeta).
2. **Asegúrate de tener Python:** Debes tener instalado Python 3 en tu sistema.
3. **Ejecuta el archivo principal:** Abre tu terminal o consola en la carpeta del proyecto y ejecuta:
   ```bash
   python main.py
